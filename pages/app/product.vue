    ...
    <section id="sectionProduct" class="sectionPad">
      <div class="containerGrid">
        ...
        >
          ...
          <nuxt-link class="BuyRoleButton" :to="'/app/detail-products/' + product.id">
            Detail <i class="fa fa-exclamation-circle" style="margin-left: 2px;" />
          </nuxt-link>
          <nuxt-link :to="'detail-products/' + product.id">
...
<script>
import TheContentProduct from '~/components/products/TheProductsContent.vue'
...
import TheHeroProduct from '~/components/products/TheHero.vue'
export default {
  name: 'ProductPage',
  components: {

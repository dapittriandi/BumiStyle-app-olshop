export default {
  ...
  axios: {
    ...
    baseURL: 'https://jylpaciooxarhelwslji.supabase.co',
    proxy: true,
    Headers: {
      common: {
  ...
  proxy: {
    '/api/': {
      target: 'https://jylpaciooxarhelwslji.supabase.co',
      pathRewrite: { '^/api/': 'https://jylpaciooxarhelwslji.supabase.co' },
      changeOrigin: true
    }
  },
